...
md"""
# Visualize paleographic observations
...
md"> Configuration stuff below here you can ignore"
...
# ╔═╡ b32a622e-6b92-4a9b-b984-2349317bbd61
service = IIIFservice(baseurl, root);


# ╔═╡ 733814e1-cecd-4185-a75f-ac2565d990b3
ict = "http://www.homermultitext.org/ict2/?";

# ╔═╡ 45a55737-a345-43d8-9f48-2f9b70a7fd8a

function tabulate(fname, ht = 200)
	lines = filter(l -> ! isempty(l), readlines(fname))
    tbllines = [
        "| Image | Transcription |",
        "| --- | --- | "
    ]
